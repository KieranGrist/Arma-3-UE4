...
public:
	...
	static FString ClassContainerMember(FString name, int classMemberTabs, TArray<FVector> vectors);
	static FString ClassContainerMember(FString name, int classMemberTabs, TArray<int> intArray);
	static FString ClassContainerMember(FString name, int classMemberTabs, TArray<FString> stringArray);
	static FString ClassContainerMember(FString name, int classMemberTabs, TArray<UVirtualItem*> virtualItem);
